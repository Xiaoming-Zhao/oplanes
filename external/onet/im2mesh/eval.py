...
from external.onet.im2mesh.utils.libkdtree import KDTree
from external.onet.im2mesh.utils.libmesh import check_mesh_contains
from external.onet.im2mesh.common import compute_iou
...
class MeshEvaluator(object):
    ...
    def eval_mesh(self, mesh, pointcloud_tgt, normals_tgt,
        ...
        if len(mesh.vertices) != 0 and len(mesh.faces) != 0:
            ...
            pointcloud = pointcloud_pred.astype(np.float32)
    ...
    # def orig_eval_mesh(self, mesh, pointcloud_tgt, normals_tgt,
    #               points_iou, occ_tgt):
    #     ''' Evaluates a mesh.
